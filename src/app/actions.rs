...
impl AppState {
    ...
    // PORT-0.9: focus-history navigation is driven from the client shell's key
    // handling once ported; the history itself is kept server-side.
...
impl AppState {
    ...
    // PORT-0.9: the unfocus half of deferred attention-read fires from client
    // focus changes once ported. (docs/fork/port-0.9/PORT.md)
    #[allow(dead_code)]
