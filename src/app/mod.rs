...
pub struct App {
    ...
    /// Process-subtree sampler behind the `agent.usage` API.
...
fn restored_ui_prefs(snapshot: &crate::persist::SessionSnapshot) -> crate::persist::UiPrefs {
    crate::persist::UiPrefs {
        ...
        tree_show_tabs: snapshot.tree_show_tabs,
        tree_show_agents: snapshot.tree_show_agents,
...
impl App {
    pub fn new(
        ...
        let active_profile = snapshot
            .as_ref()
            .map(|snap| snap.active_profile.clone())
        ...
        // PORT-0.9: sidebar chrome geometry now lives in the client shell
        ...
        state.tree_show_tabs = ui_prefs.tree_show_tabs;
        state.tree_show_agents = ui_prefs.tree_show_agents;
