...
#[cfg(test)]
pub(crate) use self::sidebar::{expanded_sidebar_sections, workspace_drop_indicator_row};
...
pub(crate) use self::{
    ...
    sidebar::{
        ...
        agent_panel_usage_rect, all_agent_panel_entries, collapsed_sidebar_toggle_rect,
        ...
        tree_header_chevron_rect, tree_header_pin_rect, tree_header_plus_rect, tree_space_key,
        tree_tab_key, tree_view_active, workspace_drop_slots, workspace_group_chevron_rect,
...
fn compute_view_internal(
    ...
    app.view = crate::app::ViewState {
        ...
        session_badge_rect: tab_bar_view.session_badge_rect,
        terminal_area,
...
mod tests {
    ...
    fn collapsed_sidebar_keeps_active_workspace_highlight_in_terminal_mode() {
        ...
        let (ws_area, _, _) = sidebar::collapsed_sidebar_sections(app.view.sidebar_rect);
