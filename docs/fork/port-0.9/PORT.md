...
| 21 | Content-fit spaces sidebar + automations section | `a045b2b4`, `4b175bef`, `1f0c5ba9`, `4cbdb86e`, `2f6d58ba` | needs-port | `orig/src/ui/sidebar.rs` | `src/client/shell/sidebar.rs` | `sidebar_automations`, `automations_expanded`, `collapsed_space_keys` kept as data. |
